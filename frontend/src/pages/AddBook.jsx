...
const AddBook = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-black">
      <div className="bg-white/30 backdrop-blur-md border border-gray-300 rounded-lg shadow-lg w-full max-w-md p-8">
        ...
        <form onSubmit={handleSubmit} encType="multipart/form-data">
          ...
          <button
            type="submit"
            className="w-full border border-white hover:border-black  text-white py-2 rounded-lg font-semibold hover:bg-gray-900 transition duration-300"
          >
            Add Book
          </button>
        </form>
